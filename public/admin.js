...
if (profile?.role !== "admin") {
    alert(
        "Esta página es exclusiva del administrador del sistema."
    );
    ...
    .forEach((button) =>
        button.addEventListener(
            ...
            () => {
                ...
                $("#users-panel").classList.toggle(
                    "hidden",
                    button.dataset.tab !==
                        "users"
                );

                $("#areas-panel").classList.toggle(
                    "hidden",
                    button.dataset.tab !==
                        "areas"
                );
...
$("#area-form").addEventListener(
    ...
    async (event) => {
        ...
        $("#area-message").textContent =
            error
                ? error.message
                : `Área ${name} creada correctamente.`;
